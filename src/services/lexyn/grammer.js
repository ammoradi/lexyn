...
function BasicItem(rule, dotIndex, Item) {
    // <PUBLIC>
    ...
    this.newItemsFromSymbolAfterDot = function () {
        // const Item = require('./lr1item')
        // const Item = require('./slritem')
        var result = [];
...
function BasicLR1Item(rule, dotIndex, Item) {
    // <PUBLIC>

    extend(this, new BasicItem(rule, dotIndex, Item));
